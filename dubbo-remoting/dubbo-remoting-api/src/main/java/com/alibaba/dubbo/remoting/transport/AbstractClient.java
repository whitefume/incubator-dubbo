...
/**
 * AbstractClient ，重点实现了公用的重连逻辑，同时抽象了连接等模板方法
 */
public abstract class AbstractClient extends AbstractEndpoint implements Client {
    ...
    private static final ScheduledThreadPoolExecutor reconnectExecutorService =
            new ScheduledThreadPoolExecutor(2, new NamedThreadFactory("DubboClientReconnectTimer", true));
...
//    发送消息时，若断开，是否重连
    ...
    // 重连 warning 的间隔.(waring多少次之后，warning一次)
